...
const ArrayState = () => {
    ...
    return (
        <div className="p-4">
            <h3 className="demo-title">Demo5: Dizi (Array) State Yönetimi</h3>
            <div demo-card demo-card-xl space-y-4>
                <div className="card-header-list">
                    <h4 className="demo-section-title">Yapılacaklar Listesi</h4>
                    <span className="demo-count-span">{tamamlananlarSayisi} /{gorevler.length} Tamamlandı</span>
                </div>
